...
const Result: React.FC<ResultProps> = ({ result, totalWeight }) => {
  return (
    <div className="mt-12 text-center p-8 bg-white dark:bg-gray-800/50 rounded-2xl shadow-lg border-2 border-indigo-50 dark:border-gray-700">
      ...
      <div className="flex flex-col items-center justify-center">
        ...
        <div className="text-gray-500 dark:text-gray-400 text-sm">
          当前总权重值: <span className="font-mono font-bold text-gray-700 dark:text-gray-200">{totalWeight}</span>
        </div>
      </div>
